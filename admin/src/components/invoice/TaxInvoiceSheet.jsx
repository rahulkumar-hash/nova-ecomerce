...
export default function TaxInvoiceSheet({
  ...
  return (
    <div className="space-y-4">
      ...
      {showActions && (
        <div className="flex flex-wrap items-center justify-between gap-3 p-4 rounded-2xl bg-white/5 border border-white/10 no-print">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">
                Official document format with Header, Footer & Background Watermark
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold bg-white/10 hover:bg-white/15 text-white border border-white/10 transition-all cursor-pointer"
            >
              <Printer size={15} />
            ...
            {onDownload && (
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold bg-indigo-600 hover:bg-indigo-500 text-white shadow-lg shadow-indigo-600/25 transition-all cursor-pointer disabled:opacity-50"
              >
                <Download size={15} />
      ...
      >
        ...
        <div className="relative z-10 space-y-6">
          ...
          {/* 2. Metadata Strip: Invoice & Order Details */}
